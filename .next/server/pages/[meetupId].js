...
async function getStaticPaths(context) {
  ...
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://datvip10a1:datvip10a1@cluster0.ejrkdzx.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
...
/* harmony default export */ var _meetupId_ = __webpack_exports__["default"] = (index);
